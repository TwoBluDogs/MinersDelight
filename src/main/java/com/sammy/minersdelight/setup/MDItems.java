...
public class MDItems {
    ...
    public static final ItemEntry<ConsumableItem> VEGAN_STEAK_AND_POTATOES = setupBowlFoodItem("vegan_steak_and_potatoes", MDFoodValues.VEGAN_STEAK_AND_POTATOES).tag(ModTags.Items.MEALS).register();
    ...
    public static final ItemEntry<Item> BAT_ROLLS = setupItem("bat_rolls", MDFoodValues.BAT_ROLLS).tag(ModTags.Items.SNACKS).register();
    public static final ItemEntry<Item> BAT_COOKIE = setupItem("bat_cookie", MDFoodValues.BAT_COOKIE).register();
    public static final ItemEntry<Item> IMPROVISED_BARBECUE_STICK = setupItem("improvised_barbecue_stick", MDFoodValues.IMPROVISED_BARBECUE_STICK).tag(ModTags.Items.SNACKS).register();
    public static final ItemEntry<ConsumableItem> BAT_SOUP = setupBowlFoodItem("bat_soup", MDFoodValues.BAT_SOUP).tag(ModTags.Items.MEALS).register();
    ...
    public static final ItemEntry<Item> ARTHROPOD = setupItem("arthropod", MDFoodValues.ARTHROPOD).tag(MDTags.RAW_INSECT_MEAT, MDTags.BC_RAW_MEATS).register();
    public static final ItemEntry<Item> COOKED_ARTHROPOD = setupItem("cooked_arthropod", MDFoodValues.COOKED_ARTHROPOD).tag(MDTags.COOKED_INSECT_MEAT).register();
    public static final ItemEntry<Item> INSECT_SANDWICH = setupItem("insect_sandwich", MDFoodValues.INSECT_SANDWICH).tag(ModTags.Items.SNACKS).register();
    public static final ItemEntry<Item> INSECT_WRAP = setupItem("insect_wrap", MDFoodValues.INSECT_WRAP).tag(ModTags.Items.SNACKS).register();
    public static final ItemEntry<ConsumableItem> INSECT_STEW = setupBowlFoodItem("insect_stew", MDFoodValues.INSECT_STEW).tag(ModTags.Items.MEALS).register();
    public static final ItemEntry<ConsumableItem> SEASONED_ARTHROPODS = setupBowlFoodItem("seasoned_arthropods", MDFoodValues.SEASONED_ARTHROPODS).tag(ModTags.Items.MEALS).register();
    ...
    public static final ItemEntry<Item> SQUID_SANDWICH = setupItem("squid_sandwich", MDFoodValues.SQUID_SANDWICH).tag(ModTags.Items.SNACKS).register();
    public static final ItemEntry<ConsumableItem> TAKOYAKI = setupBowlFoodItem("takoyaki", MDFoodValues.TAKOYAKI).register();
    public static final ItemEntry<ConsumableItem> BOWL_OF_STUFFED_SQUID = setupBowlFoodItem("bowl_of_stuffed_squid", MDFoodValues.BOWL_OF_STUFFED_SQUID).tag(ModTags.Items.MEALS).register();
    public static final ItemEntry<ConsumableItem> GLOW_INK_PASTA = setupBowlFoodItem("glow_ink_pasta", MDFoodValues.GLOW_INK_PASTA).tag(ModTags.Items.MEALS).register();
